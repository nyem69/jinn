...
function freshDb(): Database.Database {
  ...
  // shim) applies all baseline migrations including events, handler-seed,
  // and checkpoints; the trailing init* calls are kept as no-ops for
  // documentation parity with the original test layout.
